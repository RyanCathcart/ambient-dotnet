namespace AmbientDotNet.Helpers;
...
internal static class Check
{
    ...
    {
        if (strings == null || strings.All(string.IsNullOrWhiteSpace))
            throw new ArgumentException("Value cannot be null or whitespace", nameof(strings));
    }
}
